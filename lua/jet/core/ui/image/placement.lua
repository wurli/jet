---@class Jet.Ui.Image.Placement
---@field img Jet.Ui.Image
---@field id number image placement id
---@field ns number
---@field buf number
---@field opts Jet.Ui.Image.Opts
---@field augroup number
---@field hidden? boolean
---@field closed? boolean
---@field type? Jet.Ui.Image.Type
---@field _loc? Jet.Ui.Image.Loc
---@field _state? Jet.Ui.Image.State
---@field eids number[]
---@field _extmarks? Jet.Ui.Image.Extmark[]
local M = {}
M.__index = M
...
function M:render_grid(loc)
	...
	local extmarks = {} ---@type Jet.Ui.Image.Extmark[]
...
---@param extmarks Jet.Ui.Image.Extmark[]
...
---@param state Jet.Ui.Image.State
...
function M:state()
	...
	---@class Jet.Ui.Image.State
	---@field hidden boolean
	---@field loc Jet.Ui.Image.Loc
	---@field wins number[]
	return {
